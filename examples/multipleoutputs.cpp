...
int main()
{
    ...
    MatrixXd inputLabels(4, 2);
    inputLabels << 0.0, 1.0, 0.0, 1.0, 1.0, 0.0, 1.0, 0.0;
    // in:   labels:
    // 0 1    1
    // 1 0    1
    // 0 0    0
    ...
    else
    {
        ...
        LossLayer.SetInput(secondSigmoidLayer.GetOutput());
        ...
        secondSigmoidLayer.SetBackpropInput(LossLayer.GetBackpropOutput());
        ...
        for (size_t i = 0; i < 24001; i++)
        {
            ...
            LossLayer.SetLabels(inputLabels);
