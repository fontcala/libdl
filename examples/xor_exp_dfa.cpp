...
int main()
{
    ...
    // This example shows the Feedback alignment capability
    ...
    FullyConnectedExperimentalLayer<SigmoidActivation> firstLayer(2, 2);
    FullyConnectedExperimentalLayer<SigmoidActivation> secondLayer(2, 1);
    L2LossLayer L2Layer{};
