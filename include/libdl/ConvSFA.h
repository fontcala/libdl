/** @file ConvSignedAlignmentLayer.h
 *  @author Adria Font Calvarons
 */
#ifndef CONVSIGNEDALIGNMENTLAYER_H
#define CONVSIGNEDALIGNMENTLAYER_H

#include "ConnectedBaseLayer.h"

/**
* @class ConvSignedAlignmentLayer
...
class ConvSignedAlignmentLayer final : public ConnectedBaseLayer<ConvDataDims, ActivationFunctionType, DataType>
{
protected:
...
public:
    ...
    * Example Use given defined \c vInputDepth \c vInputHeight and \c vInputWidth
    ...
    ConvSignedAlignmentLayer firstConvSignedAlignmentLayer(vFilterHeight1,
                             vFilterWidth1,
                             vPaddingHeight1,
                             vPaddingWidth1,
                             vStride1,
    ...
    @endcode
    */
    ConvSignedAlignmentLayer(const size_t aFilterHeight,
    ...
    /**
    * ConvSignedAlignmentLayer::ForwardPass
    * overrides 
    ...
    */
    ...
    /**
    * ConvSignedAlignmentLayer::BackwardPass
    * overrides 
...
ConvSignedAlignmentLayer<ActivationFunctionType, DataType>::ConvSignedAlignmentLayer(const size_t aFilterHeight,
                                                       const size_t aFilterWidth,
                                                       const size_t aPaddingHeight,
                                                       const size_t aPaddingWidth,
                                                       const size_t aStride,
                                                                                           ...
                                                                                           mFilterSize(aFilterHeight * aFilterWidth * aInputDepth)
{
    ...
    std::normal_distribution<float> vRandDistr(0, sqrt(static_cast<double>(2) / static_cast<double>(mFilterSize)));
...
ConvSignedAlignmentLayer<ActivationFunctionType, DataType>::ConvSignedAlignmentLayer(const size_t aFilterHeight,
                                                       ...
                                                       const size_t aOutputDepth,
                                                       const size_t aInputSampleNumber,
                                                       const UpdateMethod aUpdateMethod) : ConvSignedAlignmentLayer(aFilterHeight,
                                                                                                     aFilterWidth,
                                                                                                     aPaddingHeight,
                                                                                                     aPaddingWidth,
                                                                                                     aStride,
...
template <template <typename> class ActivationFunctionType, typename DataType>
void ConvSignedAlignmentLayer<ActivationFunctionType, DataType>::ForwardPass()
{
...
template <template <typename> class ActivationFunctionType, typename DataType>
void ConvSignedAlignmentLayer<ActivationFunctionType, DataType>::BackwardPass()
{
