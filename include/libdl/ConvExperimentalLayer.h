/** @file ConvExperimentalLayer.h
 *  @author Adria Font Calvarons
 */
#ifndef ConvExperimentalLayer_H
#define ConvExperimentalLayer_H

#include "ConnectedBaseLayer.h"

/**
* @class ConvExperimentalLayer
...
class ConvExperimentalLayer final : public ConnectedBaseLayer<ConvDataDims, ActivationFunctionType, DataType>
{
protected:
...
public:
    ...
    * Example Use given defined \c vInputDepth \c vInputHeight and \c vInputWidth
    ...
    ConvExperimentalLayer firstConvExperimentalLayer(vFilterHeight1,
                             vFilterWidth1,
                             vPaddingHeight1,
                             vPaddingWidth1,
                             vStride1,
    ...
    @endcode
    */
    ConvExperimentalLayer(const size_t aFilterHeight,
    ...
    /**
    * ConvExperimentalLayer::ForwardPass
    * overrides 
    ...
    */
    ...
    /**
    * ConvExperimentalLayer::BackwardPass
    * overrides 
...
ConvExperimentalLayer<ActivationFunctionType, DataType>::ConvExperimentalLayer(const size_t aFilterHeight,
                                                       const size_t aFilterWidth,
                                                       const size_t aPaddingHeight,
                                                       const size_t aPaddingWidth,
                                                       const size_t aStride,
                                                                                           ...
                                                                                           mFilterSize(aFilterHeight * aFilterWidth * aInputDepth)
{
    ...
    mMaxAbsMomentum = Eigen::Matrix<DataType, Dynamic, Dynamic>::NullaryExpr(mFilterSize,this->mOutputDims.Depth, [&]() { return 1; });
...
ConvExperimentalLayer<ActivationFunctionType, DataType>::ConvExperimentalLayer(const size_t aFilterHeight,
                                                       ...
                                                       const size_t aOutputDepth,
                                                       const size_t aInputSampleNumber,
                                                       const UpdateMethod aUpdateMethod) : ConvExperimentalLayer(aFilterHeight,
                                                                                                     aFilterWidth,
                                                                                                     aPaddingHeight,
                                                                                                     aPaddingWidth,
                                                                                                     aStride,
...
template <template <typename> class ActivationFunctionType, typename DataType>
void ConvExperimentalLayer<ActivationFunctionType, DataType>::ForwardPass()
{
...
template <template <typename> class ActivationFunctionType, typename DataType>
void ConvExperimentalLayer<ActivationFunctionType, DataType>::BackwardPass()
{
