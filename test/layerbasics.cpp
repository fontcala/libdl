...
TEST_CASE("addition skip connection should perform expected additions", "skip")
{
  ...
  MatrixXd vExpectedSum = *thirdConvLayer.GetOutput() + *secondConvLayer.GetOutput() + *firstConvLayer.GetOutput();
