...
class CNNClassificationExampleModelMirror
{
    MatrixXd mTestInput;
    MatrixXd mTestLabels;
    MatrixXd mTrainInput;
...
std::vector<size_t> CNNClassificationExampleModelMirror::runExample(const size_t aEpochNum)
{
    // NETWORK DESIGN
    const size_t vInputSampleNumber = 1;
    ...
    ConvAlignmentLayer<ReLUActivation> firstConvLayer(vFilterHeight1,
                                             vFilterWidth1,
                                             vPaddingHeight1,
                                             vPaddingWidth1,
                                             vStride1,
    ...
    const size_t vStride2 = 1;
    const size_t vOutputDepth2 = 8;
    ConvAlignmentLayer<ReLUActivation> secondConvLayer(vFilterHeight2,
                                              vFilterWidth2,
                                              vPaddingHeight2,
                                              vPaddingWidth2,
                                              vStride2,
    ...
    // fullyconnectedlayer
    FullyConnectedAlignmentLayer<LinearActivation> fcLayer(flattenLayer.GetOutputDims(), mNumCategories);
...
class CNNClassificationExampleModelSignedMirror
{
    MatrixXd mTestInput;
    MatrixXd mTestLabels;
    MatrixXd mTrainInput;
...
std::vector<size_t> CNNClassificationExampleModelSignedMirror::runExample(const size_t aEpochNum)
{
    // NETWORK DESIGN
    const size_t vInputSampleNumber = 1;
    ...
    ConvSignedAlignmentLayer<ReLUActivation> firstConvLayer(vFilterHeight1,
                                             vFilterWidth1,
                                             vPaddingHeight1,
                                             vPaddingWidth1,
                                             vStride1,
    ...
    const size_t vStride2 = 1;
    const size_t vOutputDepth2 = 8;
    ConvSignedAlignmentLayer<ReLUActivation> secondConvLayer(vFilterHeight2,
                                              vFilterWidth2,
                                              vPaddingHeight2,
                                              vPaddingWidth2,
                                              vStride2,
    ...
    // fullyconnectedlayer
    FullyConnectedSignedAlignmentLayer<LinearActivation> fcLayer(flattenLayer.GetOutputDims(), mNumCategories);
    ...
    for (size_t vEpoch = 0; vEpoch < aEpochNum; vEpoch++)
    {
        ...
        if (vEpoch % 1 == 0)
        {
            std::cout << "trainingLoss[" <<  vEpoch << "]" << "=" << currentlossAggregator << std::endl;
        }
    }
